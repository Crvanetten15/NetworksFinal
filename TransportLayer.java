/*
 * Description given:
 * An abstract class that encapsulates the common data structures and methods for PAR sender and receiver. 
 * The abstract method run() is to be extended by the ParSender and ParReceiver classes.
 */
